...
//
//
//TEST_F(QueueTest, iterator_erase_last) {
//  //Last is first too
//  std::string qvalues1[] = {"b"};
//  QueueType q1;
//  load(q1, "a");
//  QueueType::Iterator it1(q1.begin());
//  it1.erase();
//  q1.enqueue("b");
//  ASSERT_EQ(QueueType(qvalues1),q1);
//
//  //Last is not first
//  std::string qvalues2[] = {"a", "b", "c", "e"};
//  QueueType q2;
//  load(q2, "abcd");
//  QueueType::Iterator it2(q2.begin());
//  ++it2;
//  ++it2;
//  ++it2;
//  it2.erase();
//  q2.enqueue("e");
//  ASSERT_EQ(QueueType(qvalues2),q2);
//}
//
//
...
//  QueueType q;
//  load(q,"abcdefgh");
//  QueueType::Iterator it1(q.begin());
//
//  q.dequeue();
//  ASSERT_THROW(it1.erase(),ics::ConcurrentModificationError);
//  ASSERT_THROW(++it1,ics::ConcurrentModificationError);
//  ASSERT_THROW(it1++,ics::ConcurrentModificationError);
//  ASSERT_THROW(*it1,ics::ConcurrentModificationError);
//
//
//  QueueType::Iterator it2(q.begin());
//  QueueType::Iterator it3(q.begin());
//
//  it2.erase();
//  ASSERT_THROW(it3.erase(),ics::ConcurrentModificationError);
//  ASSERT_THROW(++it3,ics::ConcurrentModificationError);
//  ASSERT_THROW(it3++,ics::ConcurrentModificationError);
//  ASSERT_THROW(*it3,ics::ConcurrentModificationError);
//}
//
