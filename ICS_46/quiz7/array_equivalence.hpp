...
//Two values are in the same class when their equivalence trees have the same root.
...
bool ArrayEquivalence<T>::in_same_class (const T& a, const T& b) {
    if (!parent.has_key(a) || !parent.has_key(b))
        throw EquivalenceError("ArrayEquivalence::in_same_class value not in Equivalence");
...
void ArrayEquivalence<T>::add_singleton (const T& a) {
    if (parent.has_key(a))
        throw EquivalenceError("ArrayEquivalence::add_singleton value already in Equivalence");
...
void ArrayEquivalence<T>::merge_classes_of (const T& a, const T& b) {
    if (!parent.has_key(a) || !parent.has_key(b))
        throw EquivalenceError("ArrayEquivalence::merge_classes_of value not in Equivalence");
...
T ArrayEquivalence<T>::compress_to_root (T a) {
    if (!parent.has_key(a))
        throw EquivalenceError("ArrayEquivalence::compress_to_root value not in Equivalence");
